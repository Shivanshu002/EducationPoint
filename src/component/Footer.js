...
const Footer = () => {
    return (
        <div className='bg-[#0092fa] max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white'>
            <div>
                <h1 className='w-full text-3xl font-bold text-black'>eDUCATION pOINT</h1>
